...
public class QuestionFilipinoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_filipino);
        ...
        questionList = dbHelper.getAllFilipinoQuestions();
